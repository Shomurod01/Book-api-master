...
#[ApiResource(
    ...
    denormalizationContext: ['groups' => ['user:write', 'user:auth']],
    extraProperties: [
        'standard_put' => true,
    ],
)]
    ...
    PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\Email]
    #[Groups(['users:read', 'user:auth', 'user:write', 'user:put:write', 'user:isUniqueEmail:write'])]
    private ?string $email = null;

    #[ORM\Column(type: 'string', length: 255)]
    #[Groups(['user:write', 'user:auth', 'user:changePassword:write'])]
